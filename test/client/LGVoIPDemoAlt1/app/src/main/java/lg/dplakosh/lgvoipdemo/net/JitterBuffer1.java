...
public class JitterBuffer1 implements Serializable {
  private static final String TAG = JitterBuffer1.class.getSimpleName();
  ...
  public JitterBuffer1(int jitter, int waitingTime) {
