...
Java_lg_dplakosh_lgvoipdemo_codec_audio_OpusCodec_opusOpenNative(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT jint JNICALL
Java_lg_dplakosh_lgvoipdemo_codec_audio_OpusCodec_opusDecodeNative(JNIEnv *env, jclass type,
                                                            jbyteArray input_,
                                                            jint frameSize,
                                                            jbyteArray output_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_lg_dplakosh_lgvoipdemo_codec_audio_OpusCodec_opusEncodeNative(JNIEnv *env, jclass type,
                                                            jbyteArray input_,
                                                            jint frameSize,
                                                            jbyteArray output_) {
...
Java_lg_dplakosh_lgvoipdemo_codec_audio_OpusCodec_opusCloseNative(JNIEnv *env, jclass type) {
  if (--codec_open != 0)
    return;
