...
Java_com_lg_sixsenses_willi_codec_audio_GsmCodec_gsmOpenNative(JNIEnv *env, jclass type) {
    if (codec_open != 0) {
        codec_open++;
        return (jint) 0;
    }
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_lg_sixsenses_willi_codec_audio_GsmCodec_gsmDecodeNative(JNIEnv *env, jclass type,
                                                             jbyteArray input_,
                                                             jbyteArray output_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_lg_sixsenses_willi_codec_audio_GsmCodec_gsmEncodeNative(JNIEnv *env, jclass type,
                                                             jbyteArray input_,
                                                             jbyteArray output_) {
...
Java_com_lg_sixsenses_willi_codec_audio_GsmCodec_gsmCloseNative(JNIEnv *env, jclass type) {
    if (--codec_open != 0)
        return;
